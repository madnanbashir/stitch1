...
+function(window, $, _) {
    ...
    window.LCB.RoomView = Backbone.View.extend({
        ...
        atwhoMentions: function () {
            ...
            .atwho({
                at: '@',
                tpl: '<li data-value="@${username}"><img src="/getProfilePicture/${username}" height="20" width="20" /> @${username} <small>${displayName}</small></li>',
                callbacks: {
        ...
        archiveRoom: function(e) {
            ...
            swal({
                title: 'Do you really want to archive "' +
                       this.model.get('name') + '"?',
                text: "You will not be able to access it afterwards!",
                type: "error",
